...
function seedFarmStateScript(taskId) {
  return () => {
    ...
    const plotCount = isT11 ? 7 : (isT12 || isT13 || isT14 || isT15 || isT16) ? 9 : 4;
    ...
    const plots = isT11
      ...
      : (isT12 || isT14 || isT15 || isT16)
        ? basePlots.map((plot, index) => {
          const matureIndexes = (isT14 || isT15 || isT16) ? [2, 5, 8] : [2, 3, 6, 8];
...
async function captureCurrentScreenshots(outputDir, taskId) {
  ...
  try {
    for (const viewport of viewports) {
      ...
      const reviewUrl = taskId === 'E-001-T13' || taskId === 'E-001-T14' || taskId === 'E-001-T15' || taskId === 'E-001-T16'
...
function buildCompareHeaderSvg(width, headerHeight, viewportName, taskId) {
  ...
  const referenceLabel = taskId === 'E-001-T12' || taskId === 'E-001-T13' || taskId === 'E-001-T14' || taskId === 'E-001-T15' || taskId === 'E-001-T16'
...
function buildChangeMarkersSvg(totalWidth, totalHeight, viewportName, taskId, headerHeight) {
  if (taskId !== 'E-001-T11' && taskId !== 'E-001-T12' && taskId !== 'E-001-T13' && taskId !== 'E-001-T14' && taskId !== 'E-001-T15' && taskId !== 'E-001-T16') {
    return null;
  }
  ...
  const points = (taskId === 'E-001-T12' || taskId === 'E-001-T13' || taskId === 'E-001-T14' || taskId === 'E-001-T15' || taskId === 'E-001-T16') ? t12Points : t11Points;
  const legendWidth = viewportName === 'mobile' ? 260 : 350;
  const legendX = totalWidth - legendWidth - 14;
  const legendY = headerHeight + 16;
  const line1 = taskId === 'E-001-T16'
...
async function generateCompareArtifacts(runId, taskId) {
  ...
  try {
    ...
    for (const viewport of viewports) {
      const baselinePath = taskId === 'E-001-T12' || taskId === 'E-001-T13' || taskId === 'E-001-T14' || taskId === 'E-001-T15' || taskId === 'E-001-T16'
      ...
      if (taskId === 'E-001-T12' || taskId === 'E-001-T13' || taskId === 'E-001-T14' || taskId === 'E-001-T15' || taskId === 'E-001-T16') {
