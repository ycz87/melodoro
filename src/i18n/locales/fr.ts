...
export const fr: Messages = {
  ...
  itemName: (id) => ({
    ...
    'lullaby-record': 'Berceuse Primordiale',
  ...
  itemDescription: (id) => ({
    ...
    'lullaby-record': 'Berceuse primordiale, apaise les cultures et favorise la croissance',
  ...
  itemFlavor: (id) => ({
    ...
    lullaby: 'Une berceuse alien qui fait pousser les pastèques très vite',
  ...
  revealedNormalSeedLabel: (varietyName) => `🔮 Graine révélée (${varietyName})`,
  revealedNormalSeedHint: 'Résultat de la boule de cristal : cette graine normale réservée donnera exactement cette variété',
