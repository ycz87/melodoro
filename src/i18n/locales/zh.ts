...
export const zh: Messages = {
  ...
  marketTitle: '🏪 商城',
  marketBalance: '瓜币余额',
  marketHeroTitle: '货在流，价在跳，交易正在发生',
  marketHeroSubtitle: '先看每周特惠，再补常驻道具和地块扩展，一眼扫完整张清单。',
  marketTabBuy: '🛒 买',
  marketTabSell: '💰 卖',
  marketTabWeekly: '🎁 每周特惠',
  marketGoodsSection: '🧺 常驻商品',
  ...
  revealedNormalSeedLabel: (varietyName) => `🔮 已揭晓种子（${varietyName}）`,
  revealedNormalSeedHint: '水晶球结果：这颗预留的普通种子种下后会长成该品种',
