...
export const de: Messages = {
  ...
  ambienceNames: {
    ...
    campfire: 'Sammle 5 verschiedene Dicke-Erde-Sorten zum Freischalten',
    softPiano: 'Sanftes Klavier',
    catPurr: 'Katzenschnurren',
    night: 'Nacht',
    train: 'Zug',
    underwater: 'Sammle alle 8 Dicke-Erde-Sorten zum Freischalten',
  },
  ...
  varietyName: (id) => ({
    ...
    geyser: 'Geysirmelone',
    mist: 'Nebelmelone',
    wildfire: 'Sammle 5 verschiedene Dicke-Erde-Sorten zum Freischalten',
