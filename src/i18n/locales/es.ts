...
export const es: Messages = {
  ...
  ambienceNames: {
    ...
    campfire: 'Colecciona 5 variedades diferentes de Tierra Densa para desbloquear',
    softPiano: 'Piano suave',
    catPurr: 'Ronroneo de gato',
    night: 'Noche',
    train: 'Tren',
    underwater: 'Colecciona las 8 variedades de Tierra Densa para desbloquear',
  },
  ...
  varietyName: (id) => ({
    ...
    geyser: 'Melón Géiser',
    mist: 'Melón Niebla',
    wildfire: 'Colecciona 5 variedades diferentes de Tierra Densa para desbloquear',
