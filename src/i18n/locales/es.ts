...
export const es: Messages = {
  ...
  itemName: (id) => ({
    ...
    'lullaby-record': 'Nana Primordial',
  ...
  itemDescription: (id) => ({
    ...
    'lullaby-record': 'Canción de cuna primordial, calma los cultivos y favorece su crecimiento',
  ...
  itemFlavor: (id) => ({
    ...
    lullaby: 'Una nana alienígena que hace crecer las sandías muy rápido',
